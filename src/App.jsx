...
const tokenModule = sdk.getTokenModule(
  "0x155ad86ab221a35990b9179AA832F0Ce83cF01d1",
);

// Our voting contract.
const voteModule = sdk.getVoteModule(
  "0x11C83c97f984887Eda5796F606b2e4f0Cd0df067",
);
  ...
  if (!address) {
    return (
      <div className="landing">
        <h1>Welcome to the DAOofIceCream</h1>
  ...
  if (hasClaimedNFT) {
    return (
      <div className="member-page">
        <right><p>Congratulations on being a member</p></right>
